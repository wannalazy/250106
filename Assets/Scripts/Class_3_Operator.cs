...
public class Class_3_Operator : MonoBehaviour
{
    ...
    // 喚醒事件 : 撥放遊戲後會執行第一個事件，只執行一次
    // 事件名稱是藍色的 (沒有變色不影響)
    private void Awake()
    {
        #region 輸出訊息
        // 將小括號內的訊息輸出到 Uniyt 的 Console 控制台面板
        ...
        // 色碼 :＃紅紅綠綠藍，數值 : 0 ~ 9，a ~ f 越右邊顏色月亮 #000 黑 #fff 白
        ...
        Debug.Log("<color=#f93>--- 並且&&、或者|| ---</color>");
